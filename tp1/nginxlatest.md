...
2025-03-17T10:43:47Z    INFO    [vuln] Vulnerability scanning is enabled
2025-03-17T10:43:47Z    INFO    [secret] Secret scanning is enabled
2025-03-17T10:43:47Z    INFO    [secret] If your scanning is slow, please try '--scanners vuln' to disable secret scanning
2025-03-17T10:43:47Z    INFO    [secret] Please see also https://trivy.dev/v0.60/docs/scanner/secret#recommendation for faster secret detection
2025-03-17T10:44:18Z    INFO    [javadb] Downloading Java DB...
2025-03-17T10:44:18Z    INFO    [javadb] Downloading artifact...        repo="mirror.gcr.io/aquasec/trivy-java-db:1"
697.86 MiB / 697.86 MiB [-------------------------------------------------------------------] 100.00% 9.23 MiB p/s 1m16s
2025-03-17T10:45:36Z    INFO    [javadb] Artifact successfully downloaded       repo="mirror.gcr.io/aquasec/trivy-java-db:1"
2025-03-17T10:45:36Z    INFO    [javadb] Java DB is cached for 3 days. If you want to update the database more frequently, "trivy clean --java-db" command clears the DB cache.
2025-03-17T10:45:36Z    INFO    Detected OS     family="debian" version="12.9"
2025-03-17T10:45:36Z    INFO    [debian] Detecting vulnerabilities...   os_version="12" pkg_num=149
2025-03-17T10:45:36Z    INFO    Number of language-specific files       num=0
2025-03-17T10:45:36Z    WARN    Using severities from other vendors for some vulnerabilities. Read https://trivy.dev/v0.60/docs/scanner/vulnerability#severity-selection for details.
...
├────────────────────┼─────────────────────┼──────────┼──────────────┼─────────────────────────┼────────────────────┼──────────────────────────────────────────────────────────────┤
│ curl               │ CVE-2024-11053      │ MEDIUM   │ fixed        │ 7.88.1-10+deb12u8       │ 7.88.1-10+deb12u10 │ curl: curl netrc password leak                               │
...
├────────────────────┼─────────────────────┼──────────┤              ├─────────────────────────┼────────────────────┼──────────────────────────────────────────────────────────────┤
│ libfreetype6       │ CVE-2025-27363      │ HIGH     │              │ 2.12.1+dfsg-5+deb12u3   │                    │ freetype: OOB write when attempting to parse font subglyph   │
